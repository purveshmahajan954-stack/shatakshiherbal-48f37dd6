      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-card border border-border/50 p-6 space-y-4">
          <form onSubmit={handleSignIn} className="space-y-3">
            ...
            <div className="relative">
              <input
                ...
                className="w-full border border-border rounded-xl px-4 py-2.5 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-primary"
              />
              <button
                type="button"
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-border rounded-xl py-2.5 text-sm font-medium hover:bg-accent/40 transition disabled:opacity-50"
          >
            {googleBusy ? (
