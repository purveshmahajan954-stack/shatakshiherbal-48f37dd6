...
const products = [
  ...
  { name: "Active Z Tablets", image: img6, desc: "Active Z Tablets are formulated to support daily energy, immunity, and overall body.....", price: 230, oldPrice: 399, save: 100, rating: 4.7, reviews: 387, badge: null, badgeColor: "", discount: 25 },
  { name: "Active Green XT", image: img7, desc: "Active Green XT is a natural wellness formula crafted to support immunity....", price: 159, oldPrice: 1499, save: 500, rating: 4.9, reviews: 612, badge: "TOP RATED", badgeColor: "bg-gold", discount: 33 },
  { name: "Active Glucose", image: img8, desc: "Active Glucose provides instant energy and helps keep your body refreshed....", price: 149, oldPrice: 549, save: 150, rating: 4.7, reviews: 298, badge: "NEW", badgeColor: "bg-primary-light", discount: 27 },
  ...
  { name: "Arthovit M", image: img10, desc: "Arthovit M is designed to support healthy joints, muscle strength....", price: 429, oldPrice: 499, save: 150, rating: 4.7, reviews: 221, badge: null, badgeColor: "", discount: 30 },
  { name: "Asthometic Capsule", image: img11, desc: "Asthometic Capsule is formulated to support respiratory wellness ....", price: 439, oldPrice: 849, save: 250, rating: 4.8, reviews: 456, badge: "BESTSELLER", badgeColor: "bg-primary", discount: 29 },
  ...
  { name: "Charma R Capsule", image: img13, desc: "Charma R Capsule is designed to support healthy skin, natural glow....", price: 339, oldPrice: 449, save: 150, rating: 4.5, reviews: 167, badge: null, badgeColor: "", discount: 33 },
