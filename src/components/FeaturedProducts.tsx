...
const products = [
  ...
  { name: "Aarogya Jeevan", image: img5, desc: "Premium ashwagandha root extract to reduce stress, boost stamina and improve sleep…", price: 549, oldPrice: 799, save: 250, rating: 4.8, reviews: 521, badge: "BESTSELLER", badgeColor: "bg-primary", discount: 31 },
  { name: "Active Z Tablets", image: img6, desc: "Classical three-fruit blend that supports digestion, gentle detox and bowel regularity…", price: 299, oldPrice: 399, save: 100, rating: 4.7, reviews: 387, badge: null, badgeColor: "", discount: 25 },
