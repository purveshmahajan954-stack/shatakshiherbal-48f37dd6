...
const products = [
  ...
  { name: "Active Green XT", image: img7, desc: "Saffron-infused Ayurvedic facial serum for a radiant complexion and even skin tone…", price: 999, oldPrice: 1499, save: 500, rating: 4.9, reviews: 612, badge: "TOP RATED", badgeColor: "bg-gold", discount: 33 },
