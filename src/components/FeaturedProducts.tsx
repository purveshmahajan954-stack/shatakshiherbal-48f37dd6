...
const products = [
  ...
  { name: "Aarogya Jeevan", image: img5, desc: "Aarogya Jeevan is dedicated to bringing natural wellness solutions for a healthier....", price: 549, oldPrice: 799, save: 250, rating: 4.8, reviews: 521, badge: "BESTSELLER", badgeColor: "bg-primary", discount: 31 },
  { name: "Active Z Tablets", image: img6, desc: "Active Z Tablets are formulated to support daily energy, immunity, and overall body.....", price: 299, oldPrice: 399, save: 100, rating: 4.7, reviews: 387, badge: null, badgeColor: "", discount: 25 },
  { name: "Active Green XT", image: img7, desc: "Active Green XT is a natural wellness formula crafted to support immunity....", price: 999, oldPrice: 1499, save: 500, rating: 4.9, reviews: 612, badge: "TOP RATED", badgeColor: "bg-gold", discount: 33 },
  { name: "Active Glucose", image: img8, desc: "Active Glucose provides instant energy and helps keep your body refreshed....", price: 399, oldPrice: 549, save: 150, rating: 4.7, reviews: 298, badge: "NEW", badgeColor: "bg-primary-light", discount: 27 },
  ...
  { name: "Charma R Capsule", image: img13, desc: "Charma R Capsule is designed to support healthy skin, natural glow....", price: 299, oldPrice: 449, save: 150, rating: 4.5, reviews: 167, badge: null, badgeColor: "", discount: 33 },
  { name: "Dr. Sona Artho Tablets", image: img14, desc: "Dr. Sona Artho Tablets are specially formulated to support joint comfort.....", price: 1499, oldPrice: 1999, save: 500, rating: 4.9, reviews: 389, badge: "TOP RATED", badgeColor: "bg-gold", discount: 25 },
];
                  ...
                  <div className="flex items-end justify-between mb-3">
                    <div>
                      <div className="flex items-baseline gap-2">
                        <span className="text-2xl font-bold text-foreground">{p.price === 899 ? "" : `₹${p.price}`}</span>
