...
const products = [
  ...
  { name: "Dr Sona Vatplus Capsule ", image: img15, desc: "Dr Sona Vatplus Capsule is a herbal wellness supplement that helps pain .....", price: 299, oldPrice: 499, save: 200, rating: 4.6, reviews: 178, badge: null, badgeColor: "", discount: 28 },
  ...
  { name: "Multivitamin Complex ", image: img17, desc: "Multivitamin Complex is support to help a daily nutritional supplements...", price: 399, oldPrice: 699, save: 300, rating: 4.7, reviews: 245, badge: "BESTSELLER", badgeColor: "bg-primary", discount: 30 },
  { name: "Glow up Capsules", image: img18, desc: "Glow up Capsules is a help to natural glow and overall wellness...", price: 249, oldPrice: 449, save: 200, rating: 4.8, reviews: 367, badge: "TOP RATED", badgeColor: "bg-gold", discount: 27 },
  { name: "Multi Shine Herbal Capsules", image: img19, desc: "Multi Shine Herbal Capsules provides to natural glow and overall wellness...", price: 199, oldPrice: 349, save: 150, rating: 4.6, reviews: 198, badge: null, badgeColor: "", discount: 25 },
  ...
  { name: "Safa Amrit Capsules", image: img24, desc: "Safa Amrit Capsules soothes improves digestive health with herbal warmth....", price: 179, oldPrice: 299, save: 120, rating: 4.7, reviews: 234, badge: null, badgeColor: "", discount: 28 },
  { name: "Sakhi Sundari ", image: img25, desc: "Sakhi Sundari  offer natural beauty and wellness....", price: 269, oldPrice: 469, save: 200, rating: 4.6, reviews: 145, badge: "NEW", badgeColor: "bg-primary-light", discount: 25 },
  { name: "Skin Z Capsules", image: img26, desc: "Skin Z Capsules help to natural nutrition for healthy skin....", price: 299, oldPrice: 549, save: 250, rating: 4.8, reviews: 312, badge: "TOP RATED", badgeColor: "bg-gold", discount: 27 },
