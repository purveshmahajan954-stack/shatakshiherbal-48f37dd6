...
const products = [
  ...
  { name: "Active Glucose", image: img8, desc: "Cold-pressed bhringraj oil to reduce hair fall, strengthen roots and add natural shine…", price: 399, oldPrice: 549, save: 150, rating: 4.7, reviews: 298, badge: "NEW", badgeColor: "bg-primary-light", discount: 27 },
