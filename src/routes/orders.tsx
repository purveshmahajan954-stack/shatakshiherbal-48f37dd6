...
import { Loader2, Package, ShoppingBag, Check, CircleDashed, XCircle, Copy, Truck, FileDown } from "lucide-react";
...
function OrderCard({ o }: { o: any }) {
  ...
  const isPaid = (o.payment_status ?? o.paymentStatus) === "paid";
  ...
  return (
    <li className="bg-white rounded-2xl shadow-card p-5 sm:p-6">
      ...
      <div className="mt-4 flex flex-wrap justify-end gap-3">
        {isPaid && (
          <button
            ...
            className="inline-flex items-center gap-2 border border-primary text-primary px-4 py-2 rounded-full text-sm font-semibold hover:bg-primary hover:text-primary-foreground transition disabled:opacity-60"
          >
