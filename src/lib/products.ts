...
const base = [
  ...
  { name: "Arsho F Powder", image: img4, desc: "Arsho F Powder helps support healthy digestion and provides relief from piles....", price: 199, oldPrice: 599, save: 400, rating: 4.6, reviews: 156, badge: null, badgeColor: "", discount: 67 },
  { name: "Aarogya Jeevan", image: img5, desc: "Aarogya Jeevan is dedicated to bringing natural wellness solutions for a healthier....", price: 199, oldPrice: 799, save: 600, rating: 4.8, reviews: 521, badge: "BESTSELLER", badgeColor: "bg-primary", discount: 75 },
  ...
  { name: "Active Glucose", image: img8, desc: "Active Glucose provides instant energy and helps keep your body refreshed....", price: 139, oldPrice: 549, save: 410, rating: 4.7, reviews: 298, badge: "NEW", badgeColor: "bg-primary-light", discount: 75 },
  ...
  { name: "C.N.Z Capsule", image: img12, desc: "C.N.Z Capsule is specially formulated to support overall wellness, immunity....", price: 420, oldPrice: 699, save: 279, rating: 4.6, reviews: 142, badge: null, badgeColor: "", discount: 40 },
  ...
  { name: "Dr. Sona Artho Tablets", image: img14, desc: "Dr. Sona Artho Tablets are specially formulated to support joint comfort.....", price: 199, oldPrice: 1999, save: 1800, rating: 4.9, reviews: 389, badge: "TOP RATED", badgeColor: "bg-gold", discount: 90 },
  ...
  { name: "Omega Capsule", image: img16, desc: "Omega Capsule helps soothe digestion and relieve gas naturally....", price: 1000, oldPrice: 440, save: -560, rating: 4.5, reviews: 134, badge: "NEW", badgeColor: "bg-primary-light", discount: 0 },
  ...
  { name: "Glow up Capsules", image: img18, desc: "Glow up Capsules is a help to natural glow and overall wellness...", price: 420, oldPrice: 449, save: 29, rating: 4.8, reviews: 367, badge: "TOP RATED", badgeColor: "bg-gold", discount: 6 },
  ...
  { name: "Purify Capsules", image: img22, desc: "Purify Capsules enhance brain function, memory and concentration....", price: 170, oldPrice: 549, save: 379, rating: 4.8, reviews: 289, badge: "BESTSELLER", badgeColor: "bg-primary", discount: 69 },
  ...
  { name: "BP Tablets", image: img2, desc: "BP Tablets strengthen immunity with powerful herbal extracts....", price: 440, oldPrice: 499, save: 59, rating: 4.8, reviews: 312, badge: "BESTSELLER", badgeColor: "bg-primary", discount: 12 },
  ...
  { name: "Vedantak Powder", image: img4, desc: "Vedantak Powder nourishes the scalp and promotes natural hair growth....", price: 1000, oldPrice: 349, save: -651, rating: 4.7, reviews: 423, badge: "TOP RATED", badgeColor: "bg-gold", discount: 0 },
  ...
  { name: "Vatmaniras", image: img9, desc: "Vatmaniras supports healthy weight management naturally....", price: 1000, oldPrice: 799, save: -201, rating: 4.5, reviews: 178, badge: null, badgeColor: "", discount: 0 },
  { name: "Liver Maniras", image: img10, desc: "Liver Maniras cleanses the body with pure ayurvedic herbs....", price: 1000, oldPrice: 349, save: -651, rating: 4.6, reviews: 234, badge: "NEW", badgeColor: "bg-primary-light", discount: 0 },
  ...
  { name: "KFT XL 2", image: img12, desc: "KFT XL 2 soothe and refresh tired eyes with herbal extracts....", price: 139, oldPrice: 340, save: 201, rating: 4.5, reviews: 145, badge: null, badgeColor: "", discount: 59 },
  ...
  { name: "Alc Maniras tablets", image: img15, desc: "Alc Maniras tablets provides natural relief from cough and cold....", price: 1000, oldPrice: 440, save: -560, rating: 4.6, reviews: 234, badge: null, badgeColor: "", discount: 0 },
  { name: "Max cold powder", image: img16, desc: "Max cold powder offers fast relief from muscle and joint pain....", price: 211, oldPrice: 399, save: 188, rating: 4.7, reviews: 289, badge: "BESTSELLER", badgeColor: "bg-primary", discount: 47 },
  { name: "Charmer capsules", image: img17, desc: "Charmer capsules supports digestion and natural detoxification....", price: 1000, oldPrice: 340, save: -660, rating: 4.8, reviews: 412, badge: "TOP RATED", badgeColor: "bg-gold", discount: 0 },
  { name: "Derma cream", image: img18, desc: "Derma cream reduce stress and boost energy naturally....", price: 440, oldPrice: 499, save: 59, rating: 4.9, reviews: 523, badge: "BESTSELLER", badgeColor: "bg-primary", discount: 12 },
  ...
  { name: "Acid capsule", image: img20, desc: "Acid capsule support healthy skin and natural blood purification....", price: 1000, oldPrice: 349, save: -651, rating: 4.6, reviews: 198, badge: "NEW", badgeColor: "bg-primary-light", discount: 0 },
  { name: "Multicomplex capsule", image: img21, desc: "Multicomplex capsule boost immunity with pure holy basil extracts....", price: 139, oldPrice: 340, save: 201, rating: 4.7, reviews: 267, badge: null, badgeColor: "", discount: 59 },
  { name: "Multi vitamin", image: img22, desc: "Multi vitamin strengthens immunity and supports overall wellness....", price: 211, oldPrice: 379, save: 168, rating: 4.6, reviews: 178, badge: null, badgeColor: "", discount: 44 },
  { name: "X gold Powder", image: img23, desc: "X gold Powder supports digestion, skin health and detoxification....", price: 1000, oldPrice: 340, save: -660, rating: 4.7, reviews: 312, badge: "BESTSELLER", badgeColor: "bg-primary", discount: 0 },
