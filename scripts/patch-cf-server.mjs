...
function patchEnv(env) {
  ...
  const keys = ["NEON_DATABASE_URL","RAZORPAY_KEY_ID","RAZORPAY_KEY_SECRET","RAZORPAY_WEBHOOK_SECRET","TWILIO_ACCOUNT_SID","TWILIO_AUTH_TOKEN","TWILIO_PHONE_NUMBER","GOOGLE_CLIENT_ID","GOOGLE_CLIENT_SECRET","CKSHIP_AUTH_TOKEN","DELIVERY_WEBHOOK_SECRET","IMGBB_API_KEY","NODE_ENV"];
  for (const k of keys) {
