...
- [CKShip payload quirks](ckship-payload-quirks.md) — address_id differs by type (prepaid=335, COD=195); collectable_amount omitted entirely for prepaid; endpoint is add-update not create.
